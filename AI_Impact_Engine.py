    ...
    try:
        ...
        with result_col2:
            ...
            if failure_rate > 25:
                ...
                st.success("✅ Operational Health: Failure rate is safe.")
            st.markdown("</div>", unsafe_allow_html=True)

        # 2. NEW: TRUST & RELIABILITY SECTION
        ...
        with t_col1:
            ...
            st.caption("The model explains ~45% of variance with minimal deviation between training and testing, ensuring non-random results.")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with t_col2:
            ...
            st.caption("Based on historical testing (MAE), the actual ROI typically falls within 0.71 points of this estimate.")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with t_col3:
            ...
            if revenue > 1000 or budget > 50:
                ...
                st.caption("Inputs are unusual for typical companies. Prediction may be less accurate.")
            else:
                st.success("High Data Match")
                st.caption("Your profile matches the core patterns the model has mastered.")
            st.markdown("</div>", unsafe_allow_html=True)
